...
function updateLocalStorage(data) {
  if(window.localStorage !== null) {
    window.localStorage.setItem("db-collections", null);
    window.localStorage.setItem("codemate-collections", JSON.stringify(data));
  }
}

function getLocalStorage() {
  // window.localStorage.setItem("codemate-collections", null);

  let data = {};
  if(window.localStorage !== null) {
    if(JSON.parse(window?.localStorage?.getItem("codemate-collections")))
      data = JSON.parse(window.localStorage.getItem("codemate-collections"));
    else {
      data = {
        bookmarks: [],
        collectionOrder: [],
